...
from models_unconditional.egnn import EGNN, GNN
from util.utils import remove_mean, remove_mean_with_mask
import numpy as np
...
class EGNN_dynamics_QM9(nn.Module):
    ...
    def _forward(self, t, xh, node_mask, edge_mask,context):
        ...
        #     context = context.view(bs*n_nodes, 1024)
        #     #h:(N,n,5)-> (N,n,6)
                ...
                for batch_idx in range(batch_size):
                    for i in range(n_nodes):
                        for j in range(n_nodes):
                            ...
                            #print(i + batch_idx * n_nodes)
                            cols.append(j + batch_idx * n_nodes)
                            #print(j + batch_idx * n_nodes)
